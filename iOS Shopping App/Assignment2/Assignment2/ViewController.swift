...
class ViewController: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout
{
    ...
    override func viewDidLoad() {
       ...
       itemArray.append(itemObject(categoryImage: UIImage(named: "IScart")!, categoryString: "Shopping Cart", productTitleOb: [" "], productImageOb: [UIImage(named: "ISrecent")!], productPriceOb: [0.00], productDescriptionOb: [" "]))
        ...
        itemArray.append(itemObject(categoryImage: UIImage(named: "ISmovies")!, categoryString: "Movies", productTitleOb: ["Shawshank Redemption", "The Lord of the Rings", "The Godfather", "Interstellar", "Rogue One", "Django: Unchained", "12 Angry Men"], productImageOb: [UIImage(named: "M1")!, UIImage(named: "M2")!, UIImage(named: "M3")!, UIImage(named: "M4")!, UIImage(named: "M5")!, UIImage(named: "M6")!, UIImage(named: "M7")!], productPriceOb: [15.39, 35.59, 15.47, 20.99, 40.99, 15.99, 5.99], productDescriptionOb: ["Lowest Price yet", "Box Set", "Includes one movie", "Arguably best film of 2015", "Side story for the Deathstar", "Accurately display mid - late 1800s America", "Investigates the ignorant decisions of humans"]));
    ...
    func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
     ...
     func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
      ...
      //      cell2.cartButton.tag = indexPath.item
     //       cell2.cartButton.addTarget(self, action: #selector(ViewController.didGoToCart), for: .touchUpInside)
            return cell2
...
//    func didGoToCart(sender: UIButton){
//        
//        self.performSegue(withIdentifier: "homeToCart", sender: sender)
//    }
