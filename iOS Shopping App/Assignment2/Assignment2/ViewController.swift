...
//      
        ...
        itemArray.append(itemObject(categoryImage: UIImage(named: "ISgrocery")!, categoryString: "Grocery", productTitleOb: ["tomatoes, lb", "bananas, per lb", "Bread", "Broccoli", "Eggs", "Apples", "Gala", "Milk"], productImageOb: [UIImage(named: "G1")!, UIImage(named: "G2")!,UIImage(named: "G3")!, UIImage(named: "G4")!, UIImage(named: "G5")!, UIImage(named: "G6")!, UIImage(named: "G7")!, UIImage(named: "G8")!],productPriceOb: [2.39, 0.59, 3.40, 1.44, 2.39, 0.59, 3.40, 1.44, 2.44, 5.55, 4.21, 1.55], productDescriptionOb: ["Sear", "is", "A", "Monkey", "Dir", "WabbaWabba!", "Dirk", "WOW will this work?"]));
        ...
        itemArray.append(itemObject(categoryImage: UIImage(named: "ISmovies")!, categoryString: "Movies", productTitleOb: ["Shawshank Redemption", "The Lord of the Rings Trilogy", "The Godfather"], productImageOb: [UIImage(named: "M1")!, UIImage(named: "M2")!, UIImage(named: "M3")!], productPriceOb: [15.30, 35.59, 15.40], productDescriptionOb: ["Awesome!", "Great!", "WabbaWabba!", "Yay"]));
...
//        cell.itemButton.setTitle(cartArray[indexPath.item].cartString, for: .normal)
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        {
            let alert0 = UIAlertController(title: "Error", message: "Too many clicks friend", preferredStyle: .alert)
